...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="T_User_viewcontrolXS.ascx.cs" Inherits="Drision.Framework.Web.T_User_viewcontrolXS" %>
<asp:GridControl ID="viewcontrolXS" ClientInstanceName="PopUpValueText" KeyFieldName = "User_ID"  OnHeaderClick="viewcontrolXS_HeaderClick" OnPageIndexChanging="viewcontrolXS_PageIndexChanging" runat="server"  AutoGenerateColumns="false" onrowdatabound="viewcontrolXS_RowDataBound" ShowFooter="false" >
<Columns>
...
<PagerSettings ShowPager="true" PageIndex="0" PageSize="10">
    <PagerButtons>
        <asp:LinkButton ID="btnviewcontrolXSExport" runat="server" Text="导出" Visible = "False" OnClick="btnviewcontrolXSExport_Click"></asp:LinkButton>
    </PagerButtons>
</PagerSettings>
</asp:GridControl>