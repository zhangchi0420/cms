...
{
    public partial class T_Columns_Query : BasePage,IPage_T_Columns_Query
    {
        //实现接口
        
                SText IPage_T_Columns_Query.tbColumns_Name{get { return this.tbColumns_Name; }} 
                ComboControl IPage_T_Columns_Query.qc_State3H{get { return this.qc_State3H; }} 
                SText IPage_T_Columns_Query.qc_MenuKeyU2{get { return this.qc_MenuKeyU2; }} 

        public override long PageID
        {
            get
            {
                return 2000000308225;
            }
        }  
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //绑定枚举 
                            qc_State3H.DataSource = typeof(global::Drision.Framework.Enum.T_ColumnsStateEnum);
        qc_State3H.DataBind();
                    ...
                    {
                        __SelectViewControlID = 2000000308230;
                    }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.AddOrUpdateQueryCondition(this.qc_State3H, null);   
                this.AddOrUpdateQueryCondition(this.qc_MenuKeyU2, null);   
                ...
                if (!this.IsPostBack)
                {
                    ...
                    if(Request.QueryString["ViewID"] == null)
                    {
                        Hidden_SelectViewControlID.Value = "2000000308230";
                    }
                    else
                    {
...
DefaultViewListItem.CssClass = "";
            if(__SelectViewControlID == 2000000308230)
            {
DefaultViewListItem.CssClass = "hot_line";
                __ViewControlName = "DefaultViewControl";
                uc = this.LoadControl("~/AutoUserControls/CMS_Article/T_Columns_DefaultViewControl.ascx");
                uc.ID = "DefaultViewControl";
                this.lblViewControlTitle.Text =  "栏目列表";
            }
...
protected void btnAdd_Click(object sender, EventArgs e)
{
    try
    {
        string __RedirectURL = string.Empty;
            __RedirectURL = "~/CMS_Article/T_Columns_Add.aspx";
