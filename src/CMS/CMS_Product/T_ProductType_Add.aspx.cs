...
{
    public partial class T_ProductType_Add : BasePage,IPage_T_ProductType_Add
    {   
        //实现接口
        
                TextControl IPage_T_ProductType_Add.tbProductType_Name{get { return this.tbProductType_Name; }} 
                TextControl IPage_T_ProductType_Add.txtMenuKeyJY{get { return this.txtMenuKeyJY; }} 

        public override long PageID
        {
            get
            {
                return 2000000308027;
            }
        }  
...
protected void btnSave_Click(object sender, EventArgs e)
{
    try
    {
        ...
        global::Drision.Framework.Entity.T_ProductType entityModel = null;
            entityModel = new global::Drision.Framework.Entity.T_ProductType();
         ...
         private void CreateModel(global::Drision.Framework.Entity.T_ProductType entityModel)
{
                ...
                entityModel.SetPropertyConvertValue("MenuKey",txtMenuKeyJY.GetValue());
