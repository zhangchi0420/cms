...
{
    public partial class T_Product_Edit : BasePage,IPage_T_Product_Edit
    {     
        //实现接口
        
                TextControl IPage_T_Product_Edit.tbProduct_Name{get { return this.tbProduct_Name; }} 
                Uploader IPage_T_Product_Edit.txtImgEV{get { return this.txtImgEV; }} 
                TextControl IPage_T_Product_Edit.txtUrlX6{get { return this.txtUrlX6; }} 
                TextControl IPage_T_Product_Edit.txtProductSummaryCR{get { return this.txtProductSummaryCR; }} 
                ComboControl IPage_T_Product_Edit.txtStateFY{get { return this.txtStateFY; }} 
                TextControl IPage_T_Product_Edit.txtDesignStyleA6{get { return this.txtDesignStyleA6; }} 
                TextControl IPage_T_Product_Edit.txtDesignersT8{get { return this.txtDesignersT8; }} 
                TextControl IPage_T_Product_Edit.txtAreaHS{get { return this.txtAreaHS; }} 
                Dropdown IPage_T_Product_Edit.ddlProductTypeIdEN{get { return this.ddlProductTypeIdEN; }} 
  
        public override long PageID
        {
            get
            {
                return 2000000308095;
            }
        }  
            ...
            try
            {
                if (!this.IsPostBack)
                {
                    ...
                    //绑定启动流程下拉选择框
                     ...
                     //绑定枚举 
                            txtStateFY.DataSource = typeof(global::Drision.Framework.Enum.T_ProductStateEnum);
        txtStateFY.DataBind();
...
ddlProductTypeIdEN.Items.Add(new ComboItem() 
                { 
        ...
        private void InitData()
        {
            ...
            string FormatString = string.Empty;
                                        ...
                                        try
                                        {
                                            tbProduct_Name.SetValue(entityModel.Product_Name);
                                        }
                                        catch(Exception){}
                                    ...
                                    try
                                    {
                                        txtImgEV.SetValue(entityModel.Img);
                                    }
                                    catch(Exception){}
                                        ...
                                        try
                                        {
                                            txtUrlX6.SetValue(entityModel.Url);
                                        }
                                        catch(Exception){}
                                        ...
                                        try
                                        {
                                            txtProductSummaryCR.SetValue(entityModel.ProductSummary);
                                        }
                                        catch(Exception){}
                                        ...
                                        try
                                        {
                                            txtStateFY.SetValue(entityModel.State);
                                        }
                                        catch(Exception){}
                                        ...
                                        try
                                        {
                                            txtDesignStyleA6.SetValue(entityModel.DesignStyle);
                                        }
                                        catch(Exception){}
                                        ...
                                        try
                                        {
                                            txtDesignersT8.SetValue(entityModel.Designers);
                                        }
                                        catch(Exception){}
                                        ...
                                        try
                                        {
                                            txtAreaHS.SetValue(entityModel.Area);
                                        }
                                        catch(Exception){}
                                        ...
                                        try
                                        {
                                            ddlProductTypeIdEN.SetValue(entityModel.ProductTypeId);
                                        }
                                        catch(Exception){}
...
protected void btnSave_Click(object sender, EventArgs e)
{
    try
    {
        ...
        global::Drision.Framework.Entity.T_Product entityModel = null;
            entityModel = this.GenericHelper.FindById<global::Drision.Framework.Entity.T_Product>(__Id);
