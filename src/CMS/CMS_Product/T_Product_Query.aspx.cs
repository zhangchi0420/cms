...
{
    public partial class T_Product_Query : BasePage,IPage_T_Product_Query
    {
        //实现接口
        
                SText IPage_T_Product_Query.tbProduct_Name{get { return this.tbProduct_Name; }} 
                ComboControl IPage_T_Product_Query.qc_StateKG{get { return this.qc_StateKG; }} 
                SText IPage_T_Product_Query.qc_DesignStyleJB{get { return this.qc_DesignStyleJB; }} 
                SText IPage_T_Product_Query.qc_Designers8H{get { return this.qc_Designers8H; }} 
                Dropdown IPage_T_Product_Query.qc_ProductTypeIdH6{get { return this.qc_ProductTypeIdH6; }} 

        public override long PageID
        {
            get
            {
                return 2000000308101;
            }
        }  
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //绑定枚举 
                            qc_StateKG.DataSource = typeof(global::Drision.Framework.Enum.T_ProductStateEnum);
        qc_StateKG.DataBind();
...
qc_ProductTypeIdH6.Items.Add(new ComboItem() 
                { 
                    ...
                    {
                        __SelectViewControlID = 2000000308106;
                    }
...
DefaultViewListItem.CssClass = "";
            if(__SelectViewControlID == 2000000308106)
            {
DefaultViewListItem.CssClass = "hot_line";
                __ViewControlName = "DefaultViewControl";
                uc = this.LoadControl("~/AutoUserControls/CMS_Product/T_Product_DefaultViewControl.ascx");
                uc.ID = "DefaultViewControl";
                this.lblViewControlTitle.Text =  "产品列表";
            }
...
protected void btnAdd_Click(object sender, EventArgs e)
{
    try
    {
        string __RedirectURL = string.Empty;
            __RedirectURL = "~/CMS_Product/T_Product_Add.aspx";
