<%@ Page Title="表单实例编辑" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="FormInstanceEdit.aspx.cs" Inherits="Drision.Framework.Web.FormWorkflow.FormInstanceEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="button_bar">
        ...
        <asp:LinkButton ID="btnReturn" runat="server" Text="返回" PostBackUrl="~/FormWorkflow/FormInstanceQuery.aspx"></asp:LinkButton>
    </div>
</asp:Content>
