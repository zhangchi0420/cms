...
{
    public partial class DepartmentQuery : BasePage,IPage_DepartmentQuery
    {
        //实现接口
        
                SText IPage_DepartmentQuery.ctrl_Department_Code{get { return this.ctrl_Department_Code; }} 
        ...
        protected override void OnInit(EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        __SelectViewControlID = 1000000381;
                    }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.AddOrUpdateQueryCondition(this.ctrl_Department_Code, null);   
                ...
                if (!this.IsPostBack)
                {
                    ...
                    if(Request.QueryString["ViewID"] == null)
                    {
                        Hidden_SelectViewControlID.Value = "1000000381";
                    }
                    else
                    {
...
ctrl_deptquery_viewlistitem.CssClass = "";
            if(__SelectViewControlID == 1000000071)
            {
ctrl_deptquery_viewlistitem.CssClass = "hot_line";
                __ViewControlName = "ctrl_deptquery_view";
                uc = this.LoadControl("~/AutoUserControls/HR_Department/T_Department_ctrl_deptquery_view.ascx");
                uc.ID = "ctrl_deptquery_view";
                this.lblViewControlTitle.Text =  "停用部门";
            }
            
            
ViewItemWK.CssClass = "";
            if(__SelectViewControlID == 1000000369)
            {
ViewItemWK.CssClass = "hot_line";
                __ViewControlName = "ViewControlC2";
                uc = this.LoadControl("~/AutoUserControls/HR_Department/T_Department_ViewControlC2.ascx");
                uc.ID = "ctrl_deptquery_view";
                this.lblViewControlTitle.Text =  "启用部门";
            }
            
            
ViewItem66.CssClass = "";
            if(__SelectViewControlID == 1000000381)
            {
ViewItem66.CssClass = "hot_line";
                __ViewControlName = "viewcontrol46";
                uc = this.LoadControl("~/AutoUserControls/HR_Department/T_Department_viewcontrol46.ascx");
                uc.ID = "ctrl_deptquery_view";
                this.lblViewControlTitle.Text =  "所有部门";
            }
            
            this.divctrl_deptquery_view.Controls.Clear();
            this.divctrl_deptquery_view.Controls.Add(uc);
        }
...
AddGridParma(thisGridParma);  
            ...
            (this.divctrl_deptquery_view.FindControl("ctrl_deptquery_view") as IUserControl).InitData();
        ...
        public void ReLoadData()
        {
            ...
            (this.divctrl_deptquery_view.FindControl("ctrl_deptquery_view") as IUserControl).LoadData();
