<%@ Page Title="流程实例查看" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ProcessInstanceDetail.aspx.cs" Inherits="Drision.Framework.Web.SystemManagement.ProcessInstanceDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="check_info check_activity">
            <asp:Repeater ID="rpActivityInstance" runat="server" OnItemDataBound="rpActivityInstance_ItemDataBound">
                <ItemTemplate>
                    ...
                    <div class="check_info_son check_approve_group" style="display: none">
    ...
    <div class="button_bar">
        ...
        <%--<asp:Button ID="btnReturn" runat="server" UseSubmitBehavior="false" Text="返回" OnClick="btnReturn_Click" />--%>
    </div>
