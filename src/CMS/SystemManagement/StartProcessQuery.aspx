<%@ Page Title="我的启动流程" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="StartProcessQuery.aspx.cs" Inherits="Drision.Framework.Web.SystemManagement.StartProcessQuery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="grid_title" id="divViewControlTitle">流程信息</div>
    <div id="divviewcontrol" runat="server">
        <asp:GridControl OnPageIndexChanging="grid_PageChanging" ID="gcProcessInstance" ClientInstanceName="gcProcessInstance" runat="server" AutoGenerateColumns="false" >
        <Columns>
            ...
            <ItemTemplate>
                 ...
                 <asp:LinkButton ID="btnCancel" Enabled='<%# Eval("CanCancel") %>' runat="server" Text="撤消" CommandArgument='<%#Eval("ProcessInstanceId") %>' OnClick="btnCancel_Click"></asp:LinkButton>
